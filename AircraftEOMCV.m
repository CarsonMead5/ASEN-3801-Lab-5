function aircraft_state_derivative = AircraftEOM( aircraft_state)
% AIRCRAFT EOM CV 
...
% @param aircraft_state_array 12x1 vector of the current state [x; y; z; phi; theta; psi; u; v; w; p; q; r]
...
% @return aircraft_state_derivative 12x1 vector of the state derivatives
    ...
    %% Function call for AeroForcesAndMoments
    ...
    pos = aircraft_state_array(1:3);
    phi = aircraft_state_array(4);
    theta = aircraft_state_array(5);
    psi = aircraft_state_array(6);
    vel = aircraft_state_array(7:9);
    ang_rates = aircraft_state_array(10:12);
