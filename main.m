...
[fitresult,gof] = createFitSP(tout, theta, tout<0.3|tout>1.25);
fprintf("Fit to response with R^2 = %.4f\n",gof.rsquare);
exportgraphics(gcf,'Figures/ShortPeriodFit.pdf');
...
[fitresult,gof] = createFitPhugoid(tout,u,tout<1.5);
fprintf("Fit to response with R^2 = %.4f\n",gof.rsquare);
exportgraphics(gcf,'Figures/PhugoidFit.pdf');
